%
% Run GMC-LRSSC and L0-LRSSC on the MNIST dataset. In each iteration num_im
...
%
function [ CE_stats, ET_stats ] = run_mnist( digits )
...
clear images labels labelssorted
